...
![image](https://github.com/DarnellChen/note/blob/master/blog/img/getMyappComment/0.PHG)
...
在General中，我们可以看到Request URL （请求链接）的信息，http://sj.qq.com/myapp/app/comment.htm就是我们要爬取的链接了；Request Method （请求方式）是post，意味着在代码实现时需要用post请求。
